                            ...
                            $dlClient.add_DownloadFileCompleted({
                                ...
                                $App.UI.form.Dispatcher.Invoke([System.Action]{
                                    ...
                                    try {
                                        ...
                                        $extractedExePath = Get-ChildItem -Path $extPath -Recurse -Filter "TorMultiplexer.exe" | Select-Object -First 1
                                        ...
                                        $cmdArgs    = "/c ping 127.0.0.1 -n 3 > nul & xcopy /Y /E /H /C /I `"$sourceDir\*`" `"$baseDir`" & rmdir /S /Q `"$extPath`" & del /Q `"$zipPath`" & start `"`" `"$currentExe`""
                                        Disable-SystemProxy
